...
public class FileInfoInConsoleModeTest {
    ...
    public void setUp() {
        ...
        fileInfo = new FileInfo("console", new FileFactory(){
    ...
    @Test
    public void shouldAskForFile() throws Exception {
    ...
    public void shouldOpenFileRequestedByUser() throws Exception {
        ...
        // given:
        userEntersFollowingInput("filename.txt");
