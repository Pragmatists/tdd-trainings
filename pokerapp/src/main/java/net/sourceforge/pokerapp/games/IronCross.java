...
public class IronCross extends PokerGame {
	...
	/***********************
	 * Constructor creates an instance of a game of Iron Cross This constructor
	 * is used by other games which can extends this game
	 * 
	 * @param a
	 *            The StartPoker instance to which this game belongs
	 * @param gameName
	...
	protected void deal() {
		...
		theApp.broadcastMessage("MESSAGE  &Playing Iron Cross, with the A-Mod.  "
	...
	protected void nextAction() {
		theApp.log(
				"IronCross.nextAction() - previous actionNum = " + actionNum, 3);
		actionNum++;
		for (int i = 0; i < theApp.getPlayerList().size(); i++) {
