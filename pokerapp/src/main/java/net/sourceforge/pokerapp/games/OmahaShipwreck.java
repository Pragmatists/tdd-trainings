            ...
            if  ( numShareWilds == 2 ) {
                for ( int i = 0; i < numShareCards; i++ ) {
                    if ( ( i != csharei[0] ) && ( i != csharei[1] ) ) {
                        if ( ( cshare[i].getRank() == Card.ACE ) || ( cshare[i].getRank() >= Card.TEN ) ) {
//
                ...
                for ( int i = 0; i < numShareCards-1; i++ ) {
                    if ( i != csharei[0] ) {
                        for ( int j = i+1; j < numShareCards; j++ ) {
                            if ( j != csharei[0] ) {
                                if ( ( he.isStraight( cshare[i], cshare[j] ) == 14.0f )  && ( cshare[i].getSuit() == cshare[j].getSuit() ) ) {
                                    return 150.0f;
                                }
                            }
                        }
                    ...
                    if ( i != csharei[0] ) {
                        for ( int j = i+1; j < numShareCards; j++ ) {
                            if ( j != csharei[0] ) {
                                ...
                                if ( ( cshare[i].getSuit() == cshare[j].getSuit() ) && ( straight > 0.0 ) ) {
                        ...
                        for ( int j = i+1; j < numShareCards; j++ ) {
                            if ( j != csharei[0] ) {
                                if ( he.rankHand( cshare[i] ) >= he.rankHand( cshare[j] ) ) {
                                    test = 105.0f + he.rankHand( cshare[i] ) + he.kicker( cshare[j] );
                                    if ( test > best ) {
                                        best = test;
                                    }
                                } else {
                ...
                for ( int i = 0; i < numShareCards-2; i++ ) {
                    for ( int j = i+1; j < numShareCards-1; j++ ) {
                        for ( int k = j+1; k < numShareCards; k++ ) {
                            if ( ( he.isStraight( cshare[i], cshare[j], cshare[k] ) == 14.0f )  && he.isFlush( cshare[i], cshare[j], cshare[k] )  ) {
                                return 150.0f;
                            }
                        }
                    }
...
//
                for ( int i = 0; i < numShareCards-2; i++ ) {
                    for ( int j = i+1; j < numShareCards-1; j++ ) {
                        for ( int k = j+1; k < numShareCards; k++ ) { 
                            if ( ( cshare[i].getRank() == cshare[j].getRank() ) && ( cshare[i].getRank() == cshare[k].getRank() ) ) {
                                test = 135.0f + he.rankHand( cshare[i] );
                                if ( test > best ) {
                                    best = test;
                                }
                    ...
                    for ( int j = i+1; j < numShareCards-1; j++ ) {
                        for ( int k = j+1; k < numShareCards; k++ ) {
                            if ( he.isFlush( cshare[i], cshare[j], cshare[k] ) ) {
                                test = 89.0f + he.kicker( new Card( Card.ACE, cshare[i].getSuit() ), cshare[i],cshare[j],cshare[k] );
                                if ( test > best ) {
                                    best = test;
                                }
                            }  
                    ...
                    if ( i != cholei[0] ) {
                        for ( int j = 0; j < numShareCards; j++ ) {      
                            if ( ( j != csharei[0] ) && ( j != csharei[1] ) ) {
                                if ( ( he.isStraight( chole[i], cshare[j] ) == 14.0f )  && ( chole[i].getSuit() == cshare[j].getSuit() ) ) {
                                    return 150.0f;
                                }
                            }
                        }
...
//
                for ( int i = 0; i < numHoleCards; i++ ) {
                    if ( i != cholei[0] ) {
                        for ( int j = 0; j < numShareCards; j++ ) {      
                            if ( ( j != csharei[0] ) && ( j != csharei[1] ) ) {
                                float straight = he.isStraight( chole[i], cshare[j] ); 
                                if ( ( chole[i].getSuit() == cshare[j].getSuit() ) && ( straight > 0.0 ) ) {
                                    test = 120.0f + straight;
                                    if ( test > best ) {
                                        best = test;
                                    }
...
//
                for ( int i = 0; i < numHoleCards; i++ ) {
                    if ( i != cholei[0] ) {
                        for ( int j = 0; j < numShareCards; j++ ) {      
                            if ( ( j != csharei[0] ) && ( j != csharei[1] ) ) {
                                if ( he.rankHand( chole[i] ) >= he.rankHand( cshare[j] ) ) {
                                    test = 105.0f + he.rankHand( chole[i] ) + he.kicker( cshare[j] );
                                    if ( test > best ) { 
                                        best = test;
                                    }
                                } else {
                                    test = 105.0f + he.rankHand( cshare[j] ) + he.kicker( chole[i] );
                                    if ( test > best ) {
                                        best = test;
                                    }
                                }
                    ...
                    if ( i != cholei[0] ) {
                        for ( int j = 0; j < numShareCards-1; j++ ) {
                            if ( j != csharei[0] ) {
                                for ( int k = j+1; k < numShareCards; k++ ) {       
                                    if ( k != csharei[0] ) {
                                        if ( ( he.isStraight( chole[i], cshare[j], cshare[k] ) == 14.0f )  && he.isFlush( chole[i], cshare[j], cshare[k] )  ) {
                                            return 150.0f;
                                        }            
                                    }
                                }
                    ...
                    if ( i != cholei[0] ) {
                        for ( int j = 0; j < numShareCards-1; j++ ) {
                            if ( j != csharei[0] ) {
                                for ( int k = j+1; k < numShareCards; k++ ) {       
                                    if ( k != csharei[0] ) {
                                        if ( ( chole[i].getRank() == cshare[j].getRank() ) && ( chole[i].getRank() == cshare[k].getRank() ) ) {
                                            test = 135.0f + he.rankHand( chole[i] );
                                            if ( test > best ) {
                                                best = test;
                                            }
                    ...
                    if ( i != cholei[0] ) {
                        for ( int j = 0; j < numShareCards-1; j++ ) {
                            if ( j != csharei[0] ) {
                                for ( int k = j+1; k < numShareCards; k++ ) {       
                                    if ( k != csharei[0] ) {
                                        float straight = he.isStraight( chole[i], cshare[j], cshare[k] );
                                        if ( he.isFlush( chole[i], cshare[j], cshare[k] ) && ( straight > 0.0f ) ) {
                                            test = 120.0f + straight;
                                            if ( test > best ) {
                                                best = test;
                                            }
                        ...
                        for ( int j = 0; j < numShareCards; j++ ) {
                            if ( j != csharei[0] ) {
                                if ( chole[i].getRank() == cshare[j].getRank() ) {
                                    for ( int k = 0; k < numShareCards; k++ ) {       
                                        if ( ( k != csharei[0] ) && ( k != j ) ) {
                                            test = 105.0f + he.rankHand( chole[i] ) + he.kicker( cshare[k] );
                                            if ( test > best ) {
                                                best = test;
                                            }
                                        }            
                                ...
                                for ( int k = 0; k < numShareCards; k++ ) {
                                    if ( ( k != csharei[0] ) && ( k != j ) && ( cshare[j].getRank() == cshare[k].getRank() ) ) {
                                        test = 105.0f + he.rankHand( cshare[j] ) + he.kicker( chole[i] );
                                        if ( test > best ) {
                                            best = test;
                                        }
                    ...
                    if ( i != cholei[0] ) {
                        for ( int j = 0; j < numShareCards-1; j++ ) {
                            if ( j != csharei[0] ) {
                                for ( int k = j+1; k < numShareCards; k++ ) {       
                                    if ( k != csharei[0] ) {
                                        if ( he.isFlush( chole[i], cshare[j], cshare[k] ) ) {
                                            test = 89.0f + he.kicker( new Card( Card.ACE, chole[i].getSuit() ), chole[i],cshare[j],cshare[k] );
                                            if ( test > best ) {
                                                best = test;
                                            }
                                        }              
                    ...
                    if ( i != cholei[0] ) {
                        for ( int j = 0; j < numShareCards-1; j++ ) {
                            if ( j != csharei[0] ) {
                                for ( int k = j+1; k < numShareCards; k++ ) {       
                                    if ( k != csharei[0] ) {
                                        if ( ( he.rankHand( chole[i] ) >= he.rankHand( cshare[j] ) ) && ( he.rankHand( chole[i] ) >= he.rankHand( cshare[k] ) ) ) {
                                            test = 45.0f + he.rankHand( chole[i] ) + he.kicker( cshare[j],cshare[k] );
                                            if ( test > best ) {
                                                best = test;
                                            }
                                        } else if ( he.rankHand( cshare[j] ) >= he.rankHand( cshare[k] ) ) {
                                            test = 45.0f + he.rankHand( cshare[j] ) + he.kicker( chole[i],cshare[k] );
                                            if ( test > best ) {
                                                best = test;
                                            }
                                        } else {
                                            test = 45.0f + he.rankHand( cshare[k] ) + he.kicker( chole[i],cshare[j] );
                                            if ( test > best ) {
                                                best = test;
                                            }
                                        }                
                                ...
                                if ( i != cholei[0] ) {                            
                                    for ( int r0 = 1; r0 <= Card.NUM_RANKS; r0++ ) {
                                        for ( int s0 = 1; s0 <= Card.NUM_SUITS; s0++ ) {
                                            test = he.rankHand( new Card( r0,s0 ), chole[i], cshare[j], cshare[k], cshare[l] );
                                            if ( test > best ) {
                                                best = test;
                                            }
                                        }
