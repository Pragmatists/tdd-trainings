 ...
 * |  0.97   | 11/06/04 | Found error in 2 wild card straight calculations.             | *
 ...
 * |         |          | the cards, this fails miserably.                              | *
...
/****************************************************
 * Seven card stud with shipwreck game definition.
 *
 * @author Dan Puperi
 * @version 1.00
 *
 **/
public class Shipwreck extends SevenCardStud {

/***********************
 * Constructor - creates a new Shipwreck game
 *
 * @param a The StartPoker instance to which this game belongs
 *
 **/
    public Shipwreck( StartPoker a ) {
        super( a, "Seven Card Stud with Shipwreck", true );
        if ( theApp.getPlayerList().size() < 2 ) {
            return;
        }
        theApp.log( "Construction a game of Seven Card Stud Shipwreck", 3 );
    } 
 ...
 **/ 
    public float bestHand( Hand h ) {
        theApp.log( "Shipwreck.bestHand( " + h + " )", 3 );
