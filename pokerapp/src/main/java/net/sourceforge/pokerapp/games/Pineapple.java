...
//   Third card down
        ...
        theApp.broadcastMessage( "MESSAGE  &Playing Pineapple.  " + ( (Player)theApp.getPlayerList().get(currPlayerIndex) ).getName() + "'s bet.");
 ...
 **/
    protected void nextAction() {
        theApp.log( "Pineapple.nextAction() - previous actionNum = " + actionNum, 3 );
        actionNum++;
        for ( int i = 0; i < theApp.getPlayerList().size(); i++ ) {
 ...
 **/
    protected void mouseClick( String name, int x, int y ) {
        theApp.log( "Pineapple.mouseClick( " + name + ", " + x + ", " + y + " )", 3 );
