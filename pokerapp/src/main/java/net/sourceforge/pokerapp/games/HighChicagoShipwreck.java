 ...
 **/
    public HighChicagoShipwreck( StartPoker a ) {
        ...
        theApp.log( "Constructing a game of Seven Card Stud High Chicago with Shipwreck", 3 );
    }
...
/**********************
 * calcChicago() used to calculate the player who has the high spade in the hole.  There are two overloaded methods because
 ...
 * the first on just uses the player list the other one uses an argument for the player list.
 *
 * @param players A String array of player names who are eligible for the high Chicago
...
//   Find lowest card in hole...that is wild along with all other of that suit
        for ( int i = 0; i < numHoleCards; i++ ) {
...
//
//   If there are 4 wilds, only need to look for royal straight flush or five of a kind.  
//
        if ( numWilds == 4 ) {
            for ( int i = 0; i < numCards; i++ ) {
                if ( ( i != ci[0] ) && ( i != ci[1] ) && ( i != ci[2] ) && ( i != ci[3] ) ) {

//     Royal straight flush
//
                    if ( ( c[i].getRank() == Card.ACE ) || ( c[i].getRank() >= Card.TEN ) ) {
                        return 150.0f;
                ...
                if ( ( i != ci[0] ) && ( i != ci[1] ) && ( i != ci[2] ) ) { 
                    for ( int j = i+1; j < numCards; j++ ) {
                        if ( ( j != ci[0] ) && ( j != ci[1] ) && ( j != ci[2] ) ) {
                            if ( ( he.isStraight( c[i], c[j] ) == 14.0f )  && ( c[i].getSuit() == c[j].getSuit() ) ) {
                                return 150.0f;
                            }
                        }
                    }
                ...
                if ( ( i != ci[0] ) && ( i != ci[1] ) && ( i != ci[2] ) ) { 
                    for ( int j = i+1; j < numCards; j++ ) {
                        if ( ( j != ci[0] ) && ( j != ci[1] ) && ( j != ci[2] ) ) {
                            ...
                            if ( ( c[i].getSuit() == c[j].getSuit() ) && ( straight > 0.0 ) ) {
                    ...
                    for ( int j = i+1; j < numCards; j++ ) {
                        if ( ( j != ci[0] ) && ( j != ci[1] ) && ( j != ci[2] ) ) {
                            if ( he.rankHand( c[i] ) >= he.rankHand( c[j] ) ) {
                                test = 105.0f + he.rankHand( c[i] ) + he.kicker( c[j] );
                                if ( test > best ) {
                                    best = test;
                                }
                            } else {
                                test = 105.0f + he.rankHand( c[j] ) + he.kicker( c[i] );
                                if ( test > best ) {
                                    best = test;
                                }
                            }
                    ...
                    for ( int j = i+1; j < numCards-1; j++ ) {
                       if ( ( j != ci[0] ) && ( j != ci[1] ) ) {
                           for ( int k = j+1; k < numCards; k++ ) {
                               if ( ( k != ci[0] ) && ( k != ci[1] ) ) {  
                                   if ( ( he.isStraight( c[i], c[j], c[k] ) == 14.0f )  && he.isFlush( c[i], c[j], c[k] )  ) {
                                       return 150.0f;
                                   }
                               }
                           }
                ...
                if ( ( i != ci[0] ) && ( i != ci[1] ) ) { 
                    for ( int j = i+1; j < numCards-1; j++ ) {
                        if ( ( j != ci[0] ) && ( j != ci[1] ) ) {
                            for ( int k = j+1; k < numCards; k++ ) {
                                if ( ( k != ci[0] ) && ( k != ci[1] ) ) {  
                                    if ( ( c[i].getRank() == c[j].getRank() ) && ( c[i].getRank() == c[k].getRank() ) ) {
                                        test = 135.0f + he.rankHand( c[i] );
                                        if ( test > best ) {
                                            best = test;
                                        }
                ...
                if ( ( i != ci[0] ) && ( i != ci[1] ) ) { 
                    for ( int j = i+1; j < numCards-1; j++ ) {
                        if ( ( j != ci[0] ) && ( j != ci[1] ) ) {
                            for ( int k = j+1; k < numCards; k++ ) {
                                if ( ( k != ci[0] ) && ( k != ci[1] ) ) {  
                                    float straight = he.isStraight( c[i], c[j], c[k] );
                                    if ( he.isFlush( c[i], c[j], c[k] ) && ( straight > 0.0f ) ) {
                                        test = 120.0f + straight;
                                        if ( test > best ) { 
                                            best = test;
                                        }
                        ...
                        if ( ( j != ci[0] ) && ( j != ci[1] ) ) {
                            if ( c[i].getRank() == c[j].getRank() ) { 
                                for ( int k = 0; k < numCards; k++ ) {
                                    if ( ( k != ci[0] ) && ( k != ci[1] ) && ( k != i ) && ( k != j ) ) {  
                                        test = 105.0f + he.rankHand( c[i] ) + he.kicker( c[k] );
                                        if ( test > best ) {
                                            best = test;
                                        }
                                    }
                            ...
                            for ( int k = j+1; k < numCards; k++ ) {
                                if ( ( k != ci[0] ) && ( k != ci[1] ) ) { 
                                    if ( he.isFlush( c[i], c[j], c[k] ) ) {
                                        test = 89.0f + he.kicker( new Card( Card.ACE, c[i].getSuit() ), c[i],c[j],c[k] );
                                        if ( test > best ) { 
                                            best = test;
                                        }
                                    }  
                    ...
                    for ( int j = i+1; j < numCards-1; j++ ) {
                        if ( ( j != ci[0] ) && ( j != ci[1] ) ) {
                            for ( int k = j+1; k < numCards; k++ ) {
                                if ( ( k != ci[0] ) && ( k != ci[1] ) ) { 
                                    if ( ( ( c[i].getRank() == Card.ACE ) || ( c[i].getRank() >= Card.TEN ) ) &&
                                         ( ( c[j].getRank() == Card.ACE ) || ( c[j].getRank() >= Card.TEN ) ) &&
                                         ( ( c[k].getRank() == Card.ACE ) || ( c[k].getRank() >= Card.TEN ) ) ) {
                                        return 74.0f;
                                    }
                                    if ( ( Math.abs( c[i].getRank()-c[j].getRank() ) <= 4.0 ) &&
                                         ( Math.abs( c[i].getRank()-c[k].getRank() ) <= 4.0 ) &&
                                         ( Math.abs( c[j].getRank()-c[k].getRank() ) <= 4.0 ) ) {
                                        if ( ( c[i].getRank() <= c[j].getRank() ) && ( c[i].getRank() <= c[k].getRank() ) ) {
                                            test = 60.0f + (float)c[i].getRank() + 4.0f;
                                            if ( test > best ) {
                                                best = test;
                                            }
                                        } else if ( c[j].getRank() <= c[k].getRank() ) {
                                            test = 60.0f + (float)c[j].getRank()+ 4.0f;
                                            if ( test > best ) {
                                                best = test;
                                            }
                                        } else {
                                            test = 60.0f + (float)c[k].getRank() + 4.0f;
                                            if ( test > best ) {
                                                best = test;
                                            }
                                        }
                ...
                if ( ( i != ci[0] ) && ( i != ci[1] ) ) { 
                    for ( int j = i+1; j < numCards-1; j++ ) {
                        if ( ( j != ci[0] ) && ( j != ci[1] ) ) {
                            for ( int k = j+1; k < numCards; k++ ) {
                                if ( ( k != ci[0] ) && ( k != ci[1] ) ) { 
                                    if ( ( he.rankHand( c[i] ) >= he.rankHand( c[j] ) ) && ( he.rankHand( c[i] ) >= he.rankHand( c[k] ) ) ) {
                                        test = 45.0f + he.rankHand( c[i] ) + he.kicker( c[j],c[k] );
                                        if ( test > best ) {
                                            best = test;
                                        }
                                    } else if ( he.rankHand( c[j] ) >= he.rankHand( c[k] ) ) {
                                        test = 45.0f + he.rankHand( c[j] ) + he.kicker( c[i],c[k] );
                                        if ( test > best ) {
                                            best = test;
                                        }
                                    } else {
                                        test = 45.0f + he.rankHand( c[k] ) + he.kicker( c[i],c[j] );
                                        if ( test > best ) {
                                            best = test;
                                        }
                                    } 
                                        ...
                                        if ( l != ci[0] ) {
                                            for ( int r0 = 1; r0 <= Card.NUM_RANKS; r0++ ) {
                                                for ( int s0 = 1; s0 <= Card.NUM_SUITS; s0++ ) {
                                                    test = he.rankHand( new Card( r0,s0 ), c[i], c[j], c[k], c[l] );
                                                    if ( test > best ) {
                                                        best = test;
                                                    }
                                                }
