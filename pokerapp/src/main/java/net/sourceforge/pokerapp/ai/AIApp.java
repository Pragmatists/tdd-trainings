 ...
 * interfaces with the server almost exactly the same as a human player. Unlike
 * PokerApp, which controls human players, this class does not have a main
 * function and therefore can't be started independant of the server.
 * 
 * @author Dan Puperi
 * @version 1.00
 * 
...
public class AIApp extends PApp {
	 ...
	 * 
	 * @param a
	 *            The StartPoker instance to which this AI belongs
	 * 
	 **/
	...
	/***********************
	 * init() function is the first thing done when the AIApp class is created.
	 * It initializes all of the variable and displays the AIFrame window.
	 **/
	public void init() {
	...
	/***********************
	 * connectSocket() function is called when this AIApp is trying to connect
	 * to the server
	 * 
	 * @param name
	...
	public void connectSocket(String name, String type) {
		...
		hostName = startUpApp.getServerListener().getServerSocket()
		...
		try {
			...
			mainWindow.sendMessage("Connection to " + hostName
					+ " successful.  Will join next game when it starts.");
	...
	/***********************
	 * disconnectSocket() function is called whenever this AIApp disconnects
	 * from the server.
	 **/
	...
	/***********************
	 * resetTable() function is called whenever a new game is about to start.
	 * For the AI, all it does it reset the list of players in the game.
	 **/
	 ...
	 * 
	 * @return The AIAction class which dictates how this AI acts when it is his
	 *         turn
	 * 
	 **/
