...
/****************************************************
 * PlayerModel is a class that is used to remember actions that other players
 * did in each circumstance. It is very basic class which will have to be
 * extened to be useful.
 * 
 * @author Dan Puperi
 * @version 1.00
 * 
