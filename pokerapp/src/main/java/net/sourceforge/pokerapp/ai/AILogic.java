...
/****************************************************
 * AILogic is an abstract class that must be extended in order to implement an
 * AI player. This class really doesn't do much - it just has a couple common
 * functions and sets up the AILogic class. Any AI to be written must be an
...
public abstract class AILogic {
	...
	/**
	 * What was the previous value of actionNum. If change, then the game action
	 * changed.
	 **/
	 ...
	 * 
	 * @param a
	 *            The AIApp to which this class belongs
	 * 
	 **/
	...
	/**********************
	 * timeToBet() is an abstract function that must be defined in any class
	 * extending this class. It is used to define what to do when it's this AI's
	 * turn to bet
	 **/
	protected abstract void timeToBet();

	/**********************
	 * newGame() is an abstract function that must be defined in any class
	 * extending this class. It is used to define what happens when a new game
	 * starts
	 **/
	public abstract void newGame();

	/**********************
	 * otherPlayerAction() is an abstract function that must be defined in any
	 * class extending this class. It is called every time another player does
	 * something
	 * 
	 * @param m
	 *            The string telling the AI what the other player did.
	 * 
	 **/
	protected abstract void otherPlayerAction(String m);

	/**********************
	 * stopLogic() is an abstract function that must be defined in any class
	 * extending this class. It is called to shut down the AI logic from running
	 **/
	 ...
	 * 
	 * @return The game preferences ArrayList which defines which game the AI
	 *         likes to play
	 **/
	...
	/**********************
	 * playerAction() function is called when another player (not this AI) does
	 * something. It then calls the otherPlayerAction() function in the derived
	 * classes in cases anything more specific needs to be done.
	 * 
	 * @param m
	 *            The string description of what the other player did
	 * 
	 **/
	...
	/**********************
	 * myBet() function calculates some common logic and then calls the specific
	 * AILogic routine
	 **/
	public void myBet() {
	...
	/**********************
	 * position() is used to figure out where you are sitting at the table. A
	 * return value of 1 is the first person past the dealer, a return value
	 * equal to the number of players at the table means this AI is the dealer.
	 * A return value of zero means it didn't find the position.
	 * 
